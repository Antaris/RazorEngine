//-----------------------------------------------------------------------------
// <copyright file="CSharpRazorCodeGenerator.cs" company="RazorEngine">
...
namespace RazorEngine.Compilation.CSharp
{
    ...
    public class CSharpRazorCodeGenerator : System.Web.Razor.Generator.CSharpRazorCodeGenerator
    {
        ...
        /// <summary>
        /// Visits any specialized spans used to introduce custom logic.
        /// </summary>
        /// <param name="span">The current span.</param>
        /// <returns>
        /// True if additional spans were matched, otherwise false.
        /// </returns>
